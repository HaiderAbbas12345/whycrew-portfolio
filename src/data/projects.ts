...
export const projects: Project[] = [
  {
    ...
    description:
      "Enterprise-grade case management platform for cybersecurity operations, featuring real-time threat analysis, automated workflows, and comprehensive reporting capabilities.",
...
export const categories = ["All", "Cybersecurity"];
