            ...
            >
              <Card className="border-0 bg-gradient-to-br from-cyber-blue/5 via-cyber-purple/5 to-cyber-green/5 backdrop-blur-sm">
                ...
                <CardContent className="space-y-4">
                  {[
                    { icon: CheckCircle, text: 'Development-first with security embedded at every stage' },
                    { icon: CheckCircle, text: 'Production-ready systems, not prototypes or demos' },
                    { icon: CheckCircle, text: 'Strong AI/ML expertise with practical implementations' },
                    { icon: Globe, text: 'Flexible engagement models and transparent communication' },
                    { icon: Calendar, text: 'Realistic timelines with agile, iterative execution' },
                    { icon: Users, text: 'Proven track record across industries and use cases' }
                  ].map((item, index) => (
