        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed max-w-md">
              Leading cybersecurity and AI development company specializing in mission-critical 
              enterprise platforms. Trusted by global organizations for complex, high-stakes projects.
            </p>
