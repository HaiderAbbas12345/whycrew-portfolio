...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Streamline operations with custom automation solutions and seamless system integrations.',
      features: [
        'Zoho CRM Customization & Workflow Automation',
        'WhatsApp-Based Real-Time Notifications',
        'API Integrations for Alerting & Visibility',
        'Custom Dashboards & Reporting Systems',
        'Business Process Automation',
        'Third-Party Service Integrations'
      ],
      technologies: ['Zoho', 'WhatsApp API', 'REST APIs', 'Webhooks', 'n8n', 'Zapier'],
      color: 'cyber-orange'
    }
  ]
